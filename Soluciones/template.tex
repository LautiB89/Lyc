...
\usepackage{mathtools, amsmath, amsbsy, amssymb, mathabx} % Agregar cuando se necesiten: amscd, amssymb, amsthm, latexsym
...
\setlist[itemize]{itemsep=0.5em,topsep=0em}
...
\newcommand{\tupla}[2]{\langle #1, #2 \rangle}